...
if (($_POST['action'] ?? '') === 'save') {
    ...
    if (empty($errors)) {
        ...
        if (admin_save_works($data_file, $works)) {
            header('Location: admin.php?message=saved&edit=' . rawurlencode($slug));
            exit;
        }
    ...
    <div class="admin-layout">
      <section class="admin-panel">
        <div class="admin-panel__head">
          ...
          <?php if ($editing_work) : ?>
            <a class="text-link" href="admin.php">新規登録に戻る</a>
          <?php endif; ?>
        </div>
          ...
          <?php foreach ($works as $work) : ?>
            <article class="admin-work-item">
              ...
              <div class="admin-work-item__actions">
                <a class="admin-action-button" href="admin.php?edit=<?php echo e($work['slug']); ?>">編集</a>
