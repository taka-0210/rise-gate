...
<main>
  ...
  <section class="prototype-comparison"><div class="section-inner"><div class="section-heading"><p class="section-label"><?php echo e($prototype['comparison']['label']); ?></p><h2><?php echo e($prototype['comparison']['title']); ?></h2><p class="prototype-comparison__message"><?php echo e($prototype['comparison']['message']); ?></p></div><div class="prototype-comparison__grid"><?php foreach ($prototype['comparison']['methods'] as $method) : ?><article class="prototype-method <?php echo !empty($method['recommended']) ? 'prototype-method--risegate' : 'prototype-method--traditional'; ?>"><p class="section-label"><?php echo e($method['label']); ?></p><h3><?php echo e($method['title']); ?></h3><ol><?php foreach ($method['steps'] as $step) : ?><li><?php echo e($step); ?></li><?php endforeach; ?></ol><p><?php echo e($method['note']); ?></p></article><?php endforeach; ?></div></div></section>
