...
<main class="ai-support-page">
  ...
  <section class="ai-use-cases"><div class="section-inner"><div class="section-heading"><p class="section-label"><?php echo e($ai['uses']['label']); ?></p><h2><?php echo e($ai['uses']['title']); ?></h2></div><div class="ai-use-cases__grid"><?php foreach ($ai['uses']['items'] as $item) : ?><article><h3><?php echo e($item['title']); ?></h3><p><?php echo e($item['body']); ?></p></article><?php endforeach; ?></div></div></section>
