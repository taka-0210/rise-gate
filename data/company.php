...
return [
    ...
    'profile' => [
        ...
        'lead' => '業務用厨房機器の販売会社の代表取締役として、長年現場と経営の両方に向き合いながら、改善を重ねてきました。',
        'body' => [
    ...
    'cta' => [
        ...
        'title' => "確認したうえで、\n相談したいことがあれば聞かせてください。",
        'title_lines' => [
            'desktop' => ['確認したうえで、', '相談したいことがあれば聞かせてください。'],
            'tablet' => ['確認したうえで、', '相談したいことがあれば', '聞かせてください。'],
            'mobile' => ['確認したうえで、', '相談したいことがあれば', '聞かせてください。'],
        ],
